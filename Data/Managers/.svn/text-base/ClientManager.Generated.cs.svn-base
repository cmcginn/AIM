...
{
    /// <summary>
    /// The manager class for Client.
    /// </summary>
    public partial class ClientManager 
        : CodeSmith.Data.EntityManagerBase<Manager, AIM.Data.Client>
    {
        /// <summary>
        /// Initializes the <see cref="ClientManager"/> class.
        /// </summary>
        /// <param name="manager">The current manager.</param>
        [System.CodeDom.Compiler.GeneratedCode("CodeSmith", "5.0.0.0")]
        public ClientManager(Manager manager)
            : base(manager)
        {
            OnCreated();
        }
        ...
        /// </summary>
        [System.CodeDom.Compiler.GeneratedCode("CodeSmith", "5.0.0.0")]
        protected System.Data.Linq.Table<AIM.Data.Client> Entity
        {
            get { return Manager.Context.Client; }
        }
        ...
        [System.CodeDom.Compiler.GeneratedCode("CodeSmith", "5.0.0.0")]
        public override AIM.Data.Client GetByKey(CodeSmith.Data.IEntityKey key)
        {
        ...
        [System.CodeDom.Compiler.GeneratedCode("CodeSmith", "5.0.0.0")]
        public AIM.Data.Client GetByKey(System.Guid id)
        {
        ...
        /// </summary>
        [System.CodeDom.Compiler.GeneratedCode("CodeSmith", "5.0.0.0")]
        public IQueryable<AIM.Data.Client> GetByImportTypeId(int importTypeId)
        {
            if (Context.LoadOptions == null) 
                return Query.GetByImportTypeId.Invoke(Context, importTypeId);
            else
                return Entity.Where(c => c.ImportTypeId == importTypeId);
        }
        ...
        private static partial class Query
        {
            ...
            [System.CodeDom.Compiler.GeneratedCode("CodeSmith", "5.0.0.0")]
            internal static readonly Func<AIM.Data.DomainContext, System.Guid, AIM.Data.Client> GetByKey = 
                System.Data.Linq.CompiledQuery.Compile(
                    (AIM.Data.DomainContext db, System.Guid id) => 
                        db.Client.FirstOrDefault(c => c.Id == id));

            [System.CodeDom.Compiler.GeneratedCode("CodeSmith", "5.0.0.0")]
            internal static readonly Func<AIM.Data.DomainContext, int, IQueryable<AIM.Data.Client>> GetByImportTypeId = 
                System.Data.Linq.CompiledQuery.Compile(
                    (AIM.Data.DomainContext db, int importTypeId) => 
                        db.Client.Where(c => c.ImportTypeId == importTypeId));
